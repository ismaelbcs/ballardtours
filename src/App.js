...
export default function App() {
 ...
 setTimeout(async() => {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-24 items-start">
    ...
    {/* SECCIÓN DETALLADA: TOUR TIBURÓN BALLENA */}
  ...
  <div className="max-w-4xl mx-auto">
    ...
    <div className="mb-12">
      ...
      <p className="text-gray-600 text-lg leading-relaxed mb-6">
        For travelers seeking the extraordinary, few marine encounters match the majesty of swimming alongside the largest fish in the ocean. A private whale shark excursion from Cabo San Lucas to the tranquil waters of La Paz is more than a simple day trip—it is a bucket-list journey into a pristine marine sanctuary.
      </p>
      <p className="text-gray-600 text-lg leading-relaxed">
        At <strong>Ballard Tours</strong>, we transform this ecological marvel into a seamlessly coordinated, luxury excursion. From your private resort pick-up in a late-model luxury SUV to stepping aboard a certified private vessel, every detail is engineered for exclusivity.
      </p>
    </div>

    {/* Bloque: Itinerario Detallado */}
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16 bg-blue-50 p-8 rounded-3xl">
      <div>
        <h3 className="text-xl font-bold text-blue-900 mb-4 flex items-center gap-2">
          <Clock size={24} /> Detailed Itinerary
        </h3>
        <ul className="space-y-4 text-gray-700">
          <li className="flex gap-3">
            <span className="font-bold text-blue-600">01.</span>
            <span><strong>Luxury Pickup:</strong> Early morning pickup in a premium SUV (Suburban/Sprinter) from your resort.</span>
          </li>
          <li className="flex gap-3">
            <span className="font-bold text-blue-600">02.</span>
            <span><strong>The Briefing:</strong> Marine biologist guide explains whale shark biology and safety protocols.</span>
          </li>
          <li className="flex gap-3">
            <span className="font-bold text-blue-600">03.</span>
            <span><strong>The Encounter:</strong> Controlled, soft water entry to swim alongside these gentle giants.</span>
          </li>
          <li className="flex gap-3">
            <span className="font-bold text-blue-600">04.</span>
            <span><strong>Gourmet Lunch:</strong> Regional cuisine at a hand-picked restaurant on the La Paz Malecón.</span>
          </li>
        </ul>
      </div>
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-blue-100">
        <h3 className="text-lg font-bold text-gray-900 mb-4">When to Go?</h3>
        <div className="space-y-3">
          <div className="flex justify-between border-b pb-2">
            <span className="font-medium">Peak Season</span>
            <span className="text-blue-600 font-bold">Nov - Apr</span>
          </div>
          <div className="flex justify-between border-b pb-2">
            <span className="font-medium">Early Season</span>
            <span className="text-gray-500">October</span>
          </div>
          <div className="flex justify-between pb-2 text-red-500 italic">
            <span>Off-Season (Closed)</span>
            <span>May - Sept</span>
          </div>
        </div>
        <p className="mt-4 text-xs text-gray-500 italic">
          *Regulated by federal environmental agencies for species conservation.
        </p>
      </div>
    </div>

    {/* Bloque: FAQ con Estrategia SEO (SGE) */}
    <div className="space-y-8">
      <h3 className="text-2xl font-bold text-gray-900 border-b pb-4">Frequently Asked Questions</h3>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <div>
            <h4 className="font-bold text-blue-900 text-lg">How much does a private tour cost?</h4>
            <p className="text-gray-600 text-sm">Ballard Tours provides all-inclusive, transparent flat rates covering luxury private transport, park fees, private boat charters, and premium gear.</p>
          </div>
          <div>
            <h4 className="font-bold text-blue-900 text-lg">Can children participate?</h4>
            <p className="text-gray-600 text-sm">Yes. Children aged 4 and older comfortable in open water can safely participate under expert guide supervision.</p>
          </div>
        </div>
        
        <div className="space-y-4">
          <div>
            <h4 className="font-bold text-blue-900 text-lg">Is it safe to swim next to them?</h4>
            <p className="text-gray-600 text-sm">Absolutely. They are harmless filter-feeders with no sharp teeth. They move at peaceful speeds and are very passive.</p>
          </div>
          <div>
            <h4 className="font-bold text-blue-900 text-lg">Can I combine tours?</h4>
            <p className="text-gray-600 text-sm">Highly recommended. You can pair your whale shark swim with an Isla Espiritu Santo Private Tour for the ultimate day.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="mt-16 text-center">
      <button 
        onClick={() => { setServicioSeleccionado('tours'); avanzarPaso(); }}
        className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-full text-lg shadow-xl transition-all transform hover:scale-105"
      >
        Book Your Private Whale Shark Safari
      </button>
      <p className="text-gray-400 text-xs mt-4 uppercase tracking-widest font-semibold">
        Limited federal daily quotas - Reserve in advance
      </p>
    </div>
  </div>
</section>
