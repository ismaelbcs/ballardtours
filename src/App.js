    ...
    return (
      <div className="animate-fade-in w-full">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          {/* 🔥 SECCIÓN MULTIPLATAFORMA DE RESEÑAS (FB, Google, TripAdvisor) 🔥 */}
          <div className="mb-16 mt-8 animate-fade-in">
              ...
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="flex -space-x-2">
                    <div className="bg-[#1877F2] p-1.5 rounded-full border-2 border-white z-30">
                      <svg viewBox="0 0 24 24" width="14" height="14" fill="white"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </div>
                    <div className="bg-white p-1.5 rounded-full border-2 border-white z-20 shadow-sm">
                    ...
                    <div className="bg-[#34E0A1] p-1.5 rounded-full border-2 border-white z-10">
                      <svg viewBox="0 0 24 24" width="14" height="14" fill="black"><path d="M22.3,10.6c-0.8-3.4-3.2-6.2-6.5-7.3c-2.4-0.8-4.9-0.5-7.1,0.7c-2.3,1.2-4,3.2-4.9,5.6C3,12.9,3.5,16,5.3,18.3c1.7,2.2,4.3,3.5,7.1,3.5c1.4,0,2.8-0.3,4.1-0.9c2.3-1.1,4.1-3,5-5.4C22.6,13.9,22.7,12.2,22.3,10.6z M12,19.8c-4.3,0-7.8-3.5-7.8-7.8S7.7,4.2,12,4.2s7.8,3.5,7.8,7.8S16.3,19.8,12,19.8z M15.7,8.6c-1.5,0-2.8,1.2-2.8,2.8c0,1.5,1.2,2.8,2.8,2.8c1.5,0,2.8-1.2,2.8-2.8C18.5,9.8,17.2,8.6,15.7,8.6z M8.3,8.6c-1.5,0-2.8,1.2-2.8,2.8c0,1.5,1.2,2.8,2.8,2.8c1.5,0,2.8-1.2,2.8-2.8C11.1,9.8,9.8,8.6,8.3,8.6z"/></svg>
                    </div>
                  </div>
            ...
            <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-6 -mx-4 px-4 lg:mx-0 lg:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
              {[
                { 
                  platform: 'google',
                ...
                { 
                  platform: 'facebook',
                  name: "Sarah M.",
                  link: "https://www.facebook.com/ballardtourservices/reviews/?id=100048743395137&sk=reviews",
                  text: { 
                    es: "¡Excelente servicio! El tour en barco transparente hacia el Arco fue impresionante y el transporte al aeropuerto llegó justo a tiempo. El vehículo estaba impecable. ¡Muy recomendado!", 
                    en: "Excellent service! The clear boat tour to the Arch was stunning and the airport shuttle was right on time. The vehicle was spotless. Highly recommended!" 
                  } 
                },
                { 
                  platform: 'google',
                ...
                // Clases compartidas para el diseño de la tarjeta
                const cardClasses = "snap-center shrink-0 w-[85vw] sm:w-[320px] lg:w-[380px] bg-white border border-gray-200 rounded-3xl p-6 md:p-8 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between";

                // Contenido interno de la reseña
                const content = (
                  <>
                    <div>
                      <div className="flex items-center gap-3 mb-4">
                        {/* Logo según la plataforma */}
                        {isFB && (
                          <div className="bg-[#1877F2] text-white p-1.5 rounded-full shrink-0">
                            <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                          </div>
                        )}
                        {isGoogle && (
                          <div className="bg-white border border-gray-100 shadow-sm p-1.5 rounded-full shrink-0">
                            <svg viewBox="0 0 24 24" width="20" height="20"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
                          </div>
                        )}
                        {isTA && (
                          <div className="bg-[#34E0A1] p-1.5 rounded-full shrink-0">
                            <svg viewBox="0 0 24 24" width="20" height="20" fill="black"><path d="M22.3,10.6c-0.8-3.4-3.2-6.2-6.5-7.3c-2.4-0.8-4.9-0.5-7.1,0.7c-2.3,1.2-4,3.2-4.9,5.6C3,12.9,3.5,16,5.3,18.3c1.7,2.2,4.3,3.5,7.1,3.5c1.4,0,2.8-0.3,4.1-0.9c2.3-1.1,4.1-3,5-5.4C22.6,13.9,22.7,12.2,22.3,10.6z M12,19.8c-4.3,0-7.8-3.5-7.8-7.8S7.7,4.2,12,4.2s7.8,3.5,7.8,7.8S16.3,19.8,12,19.8z M15.7,8.6c-1.5,0-2.8,1.2-2.8,2.8c0,1.5,1.2,2.8,2.8,2.8c1.5,0,2.8-1.2,2.8-2.8C18.5,9.8,17.2,8.6,15.7,8.6z M8.3,8.6c-1.5,0-2.8,1.2-2.8,2.8c0,1.5,1.2,2.8,2.8,2.8c1.5,0,2.8-1.2,2.8-2.8C11.1,9.8,9.8,8.6,8.3,8.6z"/></svg>
                          </div>
                        )}
                        
                        {/* Puntuación Visual (Círculos verdes en TA, Estrellas amarillas en FB/Google) */}
                        <div>
                          {isTA ? (
                          ...
                          {review.title && <p className="font-bold text-gray-900 text-sm mt-1">{review.title}</p>}
                        </div>
                      </div>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed flex-grow">"{review.text[lang]}"</p>
                    </div>
                    ...
                    <div className="mt-6 flex items-center justify-between border-t border-gray-100 pt-4">
                      ...
                      <span className={`text-[11px] font-bold flex items-center gap-1 uppercase tracking-wider ${isTA ? 'text-[#00aa6c]' : isGoogle ? 'text-[#4285F4]' : 'text-gray-400'}`}>
                        <CheckCircle size={14} className={isTA ? 'text-[#00aa6c]' : isGoogle ? 'text-[#34A853]' : 'text-[#1877F2]'} />
                ...
                // Comportamiento de Enlace (Solo FB manda a otra página)
                if (isFB) {
                  return (
                    <a key={idx} href={review.link} target="_blank" rel="noopener noreferrer" className={cardClasses}>
                      {content}
                    </a>
                  );
                } else {
