        ...
        <div className="relative bg-gray-900 pb-32 pt-24 px-4 text-center overflow-hidden">
          ...
          <div className="relative z-20 max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tight drop-shadow-lg">
              {lang === 'es' ? 'Transporte Privado y Shuttles en Los Cabos' : 'Cabo Airport Shuttle, Taxi & Private Transportation'}
        ...
        <div className="max-w-7xl mx-auto px-4 mb-16 animate-fade-in">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://g.page/r/CYogd8iYqsEMEAE/review" target="_blank" rel="noopener noreferrer" className="text-[#34A853] font-bold hover:bg-[#34A853] hover:text-white border border-[#34A853] transition-all duration-300 flex items-center gap-2 text-sm px-5 py-2.5 rounded-xl shadow-sm">

                {lang === 'es' ? 'Ver Comentarios de Google' : 'Read Google Reviews'} <ChevronRight size={16} />
          ...
          <div id="reviews-carousel" className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-6 -mx-4 px-4 lg:mx-0 lg:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
            ...
            {[
              ...
              { platform: 'google', name: "Telesfira Aguilar", date: "30 de mayo", text: { es: "magnífico servicio atención esmerada, conducción responsable es por eso que lo seguiré eligiendo...", en: "magnificent service, careful attention, responsible driving is why I will continue to choose it..." } },

              { platform: 'google', name: "Kathleen", title: "Fácil y agradable", text: { es: "Antonio era un gran comunicador antes de aterrizar y era súper profesional todo el camino a playa grande. gracias Antonio, recomiendo encarecidamente.", en: "Antonio was a great communicator before landing and was super professional all the way to playa grande. thanks Antonio, highly recommend." } },

              { platform: 'google', name: "José Romero", date: "7 de febrero de 2023", text: { es: "El traslado a mi hotel fue muy cómodo, el chófer Ismael siempre amable y atento, lo recomiendo", en: "The transfer to my hotel was very comfortable, the driver Ismael always friendly and attentive, I recommend it" } },
            ...
            {`
        {
          ...
          "@graph": [
            ...
            },
            {
              ...
              "description": "Cabo Airport Transportation & Shuttle  Private Taxi SJD in Los Cabos, Mexico.",
              "address": {
                "@type": "PostalAddress",
              ...
              <Route path="/" element={
                ...
                <>
                  ...
                  <Helmet>
                    ...
                    <meta name="twitter:title" content="Cabo Airport Transportation | Private Transfers Los Cabos | Ballard Tours" />
              ...
              <Route path="/transportation/airport-shuttle-sjd" element={
                ...
                <div className="animate-fade-in pb-10 bg-white">
                  ...
                  <Helmet>
                    ...
                    <meta name="description" content="Exclusive reporter guide to Cabo airport transportation. Best private airport to hotel taxi & shuttles to Hyatt Ziva, Hard Rock, Cabo Azul, Paradisus & more." />

                    <link rel="canonical" href="https://www.ballardtours.com/transportation/airport-shuttle-sjd" />

                    <link rel="alternate" hreflang="en" href="https://www.ballardtours.com/transportation/airport-shuttle-sjd" />

                    <link rel="alternate" hreflang="es" href="https://www.ballardtours.com/es/transportation/airport-shuttle-sjd" />
                        ...
                        <section className="my-8">
                          <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                               ...
                               {lang === 'es' ? 'Lo que dicen nuestros clientes' : 'What our clients are saying'}
                            </h3>
                            <div className="hidden md:flex gap-2">
                              <button onClick={() => { const c = document.getElementById(`mini-reviews-carousel-${hotel.slug}`); if (c) c.scrollBy({ left: -300, behavior: 'smooth' }); }} className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 text-gray-600 hover:bg-gray-100 transition-colors shadow-sm">
                                <ChevronLeft size={16} />
                              </button>
                              <button onClick={() => { const c = document.getElementById(`mini-reviews-carousel-${hotel.slug}`); if (c) c.scrollBy({ left: 300, behavior: 'smooth' }); }} className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 text-gray-600 hover:bg-gray-100 transition-colors shadow-sm">
                          ...
                          <div id={`mini-reviews-carousel-${hotel.slug}`} className="flex overflow-x-auto gap-4 pb-4 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                            {[
                              { platform: 'google', name: "Karina Delgadillo", date: "Hace 2 semanas", text: { es: "Outstanding service! Everyone was always on time, friendly, and professional. Thank you for a wonderful experience! 😊", en: "Outstanding service! Everyone was always on time, friendly, and professional. Thank you for a wonderful experience! 😊" } },
                              { platform: 'google', name: "Jani O", title: "Servicio y comunicación impecables", date: "oct 2024", text: { es: "Reservé dos viajes de ida y vuelta separados para la familia para dos días diferentes. Tuve que hacer algunos cambios cerca de las fechas de recogida y todos se manejaron profesional y fácilmente. La comunicación por WhatsApp fue casi instantánea.", en: "Booked two separate round trips for the family for two different days. Had to make some changes close to the pickup dates and all were handled professionally and easily. WhatsApp communication was almost instantaneous." } },
                              { platform: 'google', name: "Andy B", date: "20 ago 2024", text: { es: "Our driver Martin was waiting for us upon arrival at the airport in Los Cabos, he was very friendly and helpful and professional. He quickly got us into our resort and helped unload all of our luggage... I strongly recommend this company.", en: "Our driver Martin was waiting for us upon arrival at the airport in Los Cabos, he was very friendly and helpful and professional. He quickly got us into our resort and helped unload all of our luggage... I strongly recommend this company." } },
                              ...
                              <a key={i} href="https://g.page/r/CYogd8iYqsEMEAE/review" target="_blank" rel="noopener noreferrer" className="snap-center shrink-0 w-[260px] md:w-[280px] bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between cursor-pointer group">
                                <div>
                                  <div className="flex items-center gap-1 mb-2">
                                    <div className="flex text-yellow-400 text-xs">★★★★★</div>
                                  </div>
                                  <p className="text-gray-600 text-[13px] leading-relaxed italic line-clamp-4 group-hover:text-gray-800 transition-colors">"{review.text[lang]}"</p>
                                </div>
                                <div className="mt-4 pt-3 border-t border-gray-50 flex items-center justify-between">
                                  <div className="flex flex-col">
                                    <span className="font-bold text-gray-900 text-[11px]">{review.name}</span>
                                    <span className="text-[10px] text-gray-500">{review.date}</span>
                                  </div>
                                  <span className="text-[9px] font-bold flex items-center gap-1 uppercase tracking-wider text-[#34A853]">
