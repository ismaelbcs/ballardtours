  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-12 space-y-16">
        ...
        {/* 1. TIPOS DE TRANSPORTE (Imagen 1) */}
        ...
        {/* 3. RUTAS POPULARES Y POR QUÉ ELEGIRNOS (Imagen 3) */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Rutas (Links en cada hotel) */}
          ...
          {/* Por qué elegirnos */}
          <div className="lg:col-span-1 bg-blue-50 rounded-3xl border border-blue-100 p-8">
